export const MSC_MARKET_ABI = [
  ...
  {
    inputs: [],
    name: "MscMarketV1__InvalidSignature",
    type: "error",
  },
  {
    inputs: [],
    name: "MscMarketV1__LengthNotEqual",
    type: "error",
  },
  {
    inputs: [],
    name: "MscMarketV1__NotFailureOrder",
    type: "error",
  },
  {
    inputs: [],
    name: "MscMarketV1__OrderIsProcessing",
    type: "error",
  },
  {
    inputs: [],
    name: "MscMarketV1__PurchaseFailed",
    type: "error",
  },
  {
    inputs: [],
    name: "MscMarketV1__WithdrawFailed",
    type: "error",
  },
  {
    inputs: [],
